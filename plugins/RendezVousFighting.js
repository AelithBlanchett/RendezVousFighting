...
var CommandHandler = (function () {
    ...
    CommandHandler.prototype.aggressive = function (args, data) {
        attackFunc("Aggressive", data.character);
    };
...
fighter.prototype = {
    ...
    actionLight: function (roll) {
        ...
        if (attacker.isAggressive) difficulty -= 2; //If you go berzerk you hit more often.
        if (target.isAggressive) difficulty -= 2; //If you go berzerk you also get hit more often.
	...
	if (attacker.isGrappling(target)) {
        ...
        // Heavy attack bonus generated by ligt attacks is wasted if you make any other move.
        if (attacker.hasAttackBonus > 0) {
            attacker.hasAttackBonus = 0;
            windowController.addHit(attacker.name + " wasted the heavy attack bonus by making a different action!");
        }
    ...
    actionFumble: function (action) {
        ...
        switch (action) {
            ...
            case "Defensive":
                ...
                break;
            case "Aggressive":
                windowController.addHint(attacker.name + " could not focus on offense.");
                break;
        }
